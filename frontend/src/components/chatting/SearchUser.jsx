...
function SearchUser({ onClose }) {
  ...
  return (
    <div className="fixed top-7 bottom-0 left-0 right-0 bg-slate-700 bg-opacity-40 p-2 z-10">
      <div className="w-full max-w-lg mx-auto mt-10">
        ...
        <div className="bg-white mt-2 w-full p-4 rounded h-96 overflow-scroll">
          {/**no user found */}
