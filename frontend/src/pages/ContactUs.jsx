  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(
        "https://doctors-diary-backen.onrender.com/api/form/contact",
        {
          method: "POST",
          headers: {
            ...
            <div className="w-full lg:w-1/2 p-8">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  <button
                    type="submit"
                    className="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-primary focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Request a Call Back
                  </button>
                </div>
